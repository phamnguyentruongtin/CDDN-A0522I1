...
public class FuramaController {
    ...
    public String detail_service(@RequestParam(value = "namefacility")String idFacility,Model model){
        Facility facility = facilityService.findFacilityByName(idFacility);
        model.addAttribute("ser",facility);
        model.addAttribute("listSer", facilityService.listAllFacility());
        return "detail_facility";

    }
    @GetMapping("booking")
    public String booking(@RequestParam(value = "nameOfFacility")String nameOfFacility,Model model){
